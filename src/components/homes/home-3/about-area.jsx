...
import about from "@assets/img/about/profilo.png";
...
const AboutArea = () => {
    ...
    return (
        <>
            <section className="tp-about-area pb-45 pt-150 box-plr p-relative">
            ...
            <div className="container-fluid">
               <div className="row">
                  <div className="col-xl-4 col-lg-12">
                     <div className="tp-about-wrapper-thumb text-center w-[800px]   text-xl-start fadeLeft">
                        <Image src={about} width={800} height={500}  alt="theme-pure" />
                     </div>
                  </div>
                           ...
                           <div className="col-lg-8">
                              <div className="tp-about-title-wrapper p-relative">
                                 <span className="tp-section-title__pre">
                                    best <span className="title-pre-color">En iyisi</span>
                                    <AngleArrow /> 
                                 </span>
